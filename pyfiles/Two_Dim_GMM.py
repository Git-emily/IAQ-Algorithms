...
if __name__ == "__main__":
    ...
    file_name = '630094_Per1_Weekall2020-12-29_2021-02-05.csv'
    file_path = PATH + '\\Analysis_CO2\\' + file_name
    with open(file_path) as f:
        cols = len(f.readline().split(','))
    dataMat = np.genfromtxt(file_path, delimiter=',')  # , skip_header=1, usecols=range(1, cols - 1)
    # dataMat = np.mat(loadData(file_path))
